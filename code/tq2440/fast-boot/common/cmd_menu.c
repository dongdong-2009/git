...
//				printf("filesize=%d\n", filesize);
				...
				{
					//strcpy(cmd_buf, "nand erase bios; nand write.jffs2 0x30000000 bios $(filesize)");
					strcpy(cmd_buf, "nand erase uboot; nand write.jffs2 0x30000000 uboot $(filesize)");		//修改分区表
				}
				else
				{
					strcpy(cmd_buf, "SCEBOOT 0 1 0x30000000");
				...
				strcpy(cmd_buf, "usbslave 1 0x30000000; nand erase uboot; nand write.jffs2 0x30000000 uboot $(filesize)");		//修改分区表
...
#else
				sprintf(cmd_buf, "usbslave 1 0x30000000; nand erase eboot; nand write.jffs2 0x30000000 eboot $(filesize)");		//分区表改了，这里这个eboot就用不了了
				run_command(cmd_buf, 0);
#endif /* CONFIG_SURPORT_WINCE */
				break;
			}
			...
			case '5':
			{
				...
				strcpy(cmd_buf, "usbslave 1 0x30000000; nand erase rootfs; nand write.jffs2 0x30000000 rootfs $(filesize)");
				run_command(cmd_buf, 0);
				break;
			}
			...
			case '6':
			{
				...
				strcpy(cmd_buf, "loadYaffs 0x30000000 rootfs");		//修改分区表
				run_command(cmd_buf, 0);
				break;
			}
...
#endif /* CONFIG_WINCE_NK */
				{
					strcpy(cmd_buf, "usbslave 1 0x30000000; nand erase logo; nand write.jffs2 0x30000000 logo $(filesize)");		//修改分区表，这里logo页不能使用了
				}
				run_command(cmd_buf, 0);
				break;
			}
